...
import dev.dubhe.anvilcraft.data.recipe.jewel.JewelRecipeInput;
...
public class JewelCraftingMenu extends AbstractContainerMenu {
    ...
    public void slotsChanged(Container container) {
        ...
        access.execute((level, pos) ->
            changedCraftingSlots(this, level, player, sourceContainer, craftingContainer, resultContainer)
        );
    }
    ...
    private static void changedCraftingSlots(
        ...
        if (!level.isClientSide()) {
            ...
            if (recipe != null) {
                var input = new JewelRecipeInput(
                    sourceContainer.getItem(0),
